...
class Student:
    ...
    # This part is image labels setting start 
        ...
        #combo box 
        dep_combo=ttk.Combobox(current_Semester_frame,textvariable=self.var_year,width=15,font=("verdana",12,"bold"),state="readonly")
        ...
        #combo box 
        year_combo=ttk.Combobox(current_Semester_frame,textvariable=self.var_dep,width=15,font=("verdana",12,"bold"),state="readonly")
        year_combo["values"]=("Select Department","CIVIL","CSE","ECE","EEE","MECH")
        ...
        #label Course 
        year_label=Label(current_Semester_frame,text="Course",font=("verdana",12,"bold"),bg="white",fg="navyblue")
        year_label.grid(row=1,column=2,padx=5,sticky=W)

        #combo box 
        year_combo=ttk.Combobox(current_Semester_frame,textvariable=self.var_course,width=15,font=("verdana",12,"bold"),state="readonly")
        year_combo["values"]=("Select Course","BE","MBA")
        year_combo.current(0)
        ...
        student_name_entry = ttk.Entry(class_Student_frame,textvariable=self.var_std_name,width=8,font=("verdana",12,"bold"))
        ...
        student_roll_entry = ttk.Entry(class_Student_frame,textvariable=self.var_roll,width=8,font=("verdana",12,"bold"))
        ...
        student_dob_entry = ttk.Entry(class_Student_frame,textvariable=self.var_dob,width=8,font=("verdana",12,"bold"))
        ...
        student_mob_entry = ttk.Entry(class_Student_frame,textvariable=self.var_mob,width=8,font=("verdana",12,"bold"))
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="ClassIncharge Name:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        student_tutor_label.grid(row=4,column=2,padx=5,pady=5,sticky=W)

        student_tutor_entry = ttk.Entry(class_Student_frame,textvariable=self.var_teacher,width=8,font=("verdana",12,"bold"))
        ...
        search_btn=Button(search_frame,command=self.search_data,text="Search",width=5,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        search_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=7,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        table_frame.place(x=10,y=90,width=565,height=330)
        ...
        self.student_table.heading("Sem",text="Course")
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_Semester.get=="Select Semester" or self.var_year.get()=="Select Year" or self.var_course.get()=="Select Course" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
        ...
        if self.var_dep.get()=="Select Department" or self.var_Semester.get=="Select Semester" or self.var_year.get()=="Select Year" or self.var_course.get()=="Select Course" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(user='root', password='',host='localhost',database='face_recognition',port=3306)
                    mycursor = conn.cursor()
                    mycursor.execute("update student set Name=%s,Department=%s,Semester=%s,Year=%s,Course=%s,Division=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Roll_No=%s,Email=%s,Teacher_Name=%s,PhotoSample=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_Semester.get(),
                    self.var_year.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Department,Semester,Year,Course,Division,Gender,DOB,Mobile_No,Address,Roll_No,Email,Teacher_Name,PhotoSample FROM student where Roll_No='" +str(self.var_search.get()) + "'" 
