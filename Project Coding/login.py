...
# This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Real Time Face Recognition Attendance System",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        std_b1_1.place(x=250,y=260,width=180,height=45)
        ...
        det_b1_1.place(x=480,y=260,width=180,height=45)
        ...
        att_b1_1.place(x=710,y=260,width=180,height=45)
        ...
        hlp_b1_1.place(x=940,y=260,width=180,height=45)
        ...
        tra_b1_1.place(x=250,y=470,width=180,height=45)
        ...
        pho_b1_1.place(x=480,y=470,width=180,height=45)
        ...
        dev_b1_1.place(x=710,y=470,width=180,height=45)
        ...
        exi_b1_1.place(x=940,y=470,width=180,height=45)
